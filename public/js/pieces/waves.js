function setup() {
    ...
    skyColorTop = color('#1A090D'); // Dark Brown
    skyColorBottom = color('#431C5D'); // Dark Purple
    oceanColorTop = color('#900C3F'); // Dark Red
    oceanColorBottom = color('#FF5733'); // Bright Orange
